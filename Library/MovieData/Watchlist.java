...
public class Watchlist {
    ...
    public static void addMovieToList(String user, Movie user_movie){
        ...
        }catch(movieNotExist e){System.out.println("Movie Doesn't exist");}
        ...
        try (BufferedReader br=new BufferedReader(new FileReader(pathToList))) {
            ...
            while ((line=br.readLine())!=null) {
                if (line.startsWith(user+'-')){
                    String removedMovieIfFirst=String.format("[Movie title='%s', director='%s', releaseYear='%d']", movie.getTitle(), movie.getDirector(), movie.getReleaseYear());
                    String removedMovie=String.format(",[Movie title='%s', director='%s', releaseYear='%d']", movie.getTitle(), movie.getDirector(), movie.getReleaseYear());
